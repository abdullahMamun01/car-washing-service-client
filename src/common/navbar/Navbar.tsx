        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src={Logo} className="h-10 w-10 object-contain" alt="Flowbite Logo" />
                    <span className="self-center text-2xl text-[#8b22e2] font-semibold whitespace-nowrap dark:text-white uppercase">CARE washs spa</span>
                </a>
